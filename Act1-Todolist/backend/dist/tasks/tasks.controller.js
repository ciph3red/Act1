...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Task created successfully', type: task_entity_1.Task }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns all tasks', type: [task_entity_1.Task] }),
    __metadata("design:type", Function),
